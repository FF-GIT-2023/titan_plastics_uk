...
patch(NavBar.prototype, {
  ...
  _searchMenus: function () {
    ...
    var results = [];
    fuzzyLookup(query, this._apps, (menu) => menu.label).forEach((menu) => {
      results.push({
        category: "apps",
        name: menu.label,
    ...
    results.forEach(function (result) {
      resultsHtml +=
        "<div class='search_icons'><a class='o-menu-search-result dropdown-item col-12 ml-auto mr-auto'  style=\"background-image:url('data:image/png;base64," +
        result["webIconData"] +
        "')\" href='web#action=" +
        result["actionID"] +
        "&menu_id=" +
